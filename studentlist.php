                    ...
                    <!-- Links -->
                        <ul class="navbar-nav">
                            ...
                            <div class="nav flex-column nav" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <!---Students-->
                                <a class="nav-link active" id="v-pills-students-tab" data-toggle="pill" href="#v-pills-students" role="tab" aria-controls="v-pills-students" aria-selected="true" style="margin-top:20px;">&nbsp&nbsp&nbsp&nbsp<i class="fas fa-users"></i>&nbsp STUDENTS </a>
                                <!---Students-->
                                <!---fees-->
                                ...
                                &nbsp&nbsp&nbsp&nbsp<i class="fas fa-user-plus"></i>&nbsp ACCOUNTS &nbsp</a>
                                <!--Account-->
                            </div>
                        </ul>
                    </nav>
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade " id="v-pills-fees" role="tabpanel" aria-labelledby="v-pills-fees-tab"> 
                            ...
                            <div class="jumbotron" id="FeeSearch">
                                    <!--form-->   
                                        <form class="form" action="studentlist.php" method="POST" enctype="multipart/form-data" autocomplete="off">
